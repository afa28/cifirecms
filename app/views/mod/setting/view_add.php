...
<div class="page-inner mg-b-70">
	<div class="d-sm-flex align-items-center justify-content-between pd-b-20">
		...
		<div class="mg-t-15">
			<button type="button" class="btn btn-sm pd-x-15 btn-white btn-uppercase" onclick="window.location='<?=admin_url($this->mod.'/lists');?>'"><i data-feather="arrow-left" class="mr-2"></i><?=lang_line('button_back');?></button>
		</div>
	</div>
