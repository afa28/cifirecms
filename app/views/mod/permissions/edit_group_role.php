				...
				<div class="col-lg-12">
					...
					<div class="card">
						...
						<div class="row">
							...
							<div class="col-sm-3"><label class="mb-0"><input name="read_access" value="1" type="checkbox" class="mr-2" <?=$read_access;?>><?=lang_line('_read_access');?></label></div>
							<div class="col-sm-3"><label class="mb-0"><input name="write_access" value="1" type="checkbox" class="mr-2" <?=$write_access;?>><?=lang_line('_write_access');?></label></div>
							<div class="col-sm-3"><label class="mb-0"><input name="modify_access" value="1" type="checkbox" class="mr-2" <?=$modify_access;?>><?=lang_line('_modify_access');?></label></div>
							<div class="col-sm-3"><label class="mb-0"><input name="delete_access" value="1" type="checkbox" class="mr-2" <?=$delete_access;?>><?=lang_line('_delete_access');?></label></div>
						</div>
						</div>
					</div>
				</div>
