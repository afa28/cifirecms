...
<div class="page-inner">
	...
	<div class="card">
		<div class="card-header">
			...
			<button type="button" onclick="location.href='<?=admin_url($this->mod.'/write');?>'" class="btn btn-primary"><i data-feather="edit-3" class="wd-16"></i><span class="d-none d-lg-inline-block ml-2"><?=lang_line('button_write');?></span></button>
		</div>
